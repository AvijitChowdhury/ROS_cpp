...
void moveGoal(turtlesim::Pose goal_pose, double distance_tolerance) {
  ...
  do {
    ...
    // double v0 = 2.0;
    // double alpha = 0.5;
    double e = getDistance(turtlesim_pose.x, turtlesim_pose.y, goal_pose.x,
                           goal_pose.y);
    double E = E + e;
  ...
  } while (getDistance(turtlesim_pose.x, turtlesim_pose.y, goal_pose.x,
                       goal_pose.y) > distance_tolerance);
...
void gridClean() {
  ...
  double distance =
      getDistance(turtlesim_pose.x, turtlesim_pose.y, x_max, y_max);
}
